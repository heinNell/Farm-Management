...
('11111111-1111-1111-1111-111111111111', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '11111111-1111-1111-1111-111111111111', 'Tractor Alpha - Oil Change', 'Scheduled engine oil change for primary tractor', 'Oil Change', 'engine', 'hours', 250, '2024-02-05 09:00:00+00', '2024-01-05 09:00:00+00', 'due', 'medium', 'Mike Johnson', 2.0, 1250, 1000, 
 ARRAY['Engine Oil 15W-40', 'Oil Filter', 'Oil Drain Plug Gasket'], 
 ARRAY['Oil Drain Pan', 'Socket Wrench Set', 'Oil Filter Wrench', 'Funnel'],
 'Warm up engine, drain old oil, replace filter, refill with new oil, check levels',
 'Ensure engine is warm but not hot. Wear safety glasses and gloves. Dispose of used oil properly.'),

('22222222-2222-2222-2222-222222222222', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', '22222222-2222-2222-2222-222222222222', 'Harvester Beta - Hydraulic Check', 'Monthly hydraulic system inspection', 'Inspection', 'hydraulics', 'hours', 100, '2024-01-28 14:00:00+00', '2024-01-20 14:00:00+00', 'scheduled', 'high', 'Sarah Williams', 1.5, 850, 750,
 ARRAY['Hydraulic Fluid', 'Hydraulic Hose Clamps'],
 ARRAY['Pressure Gauge', 'Leak Detection Kit', 'Torque Wrench'],
 'Check fluid levels, inspect all hoses for wear, test system pressure, check for leaks',
 'System must be depressurized before inspection. Use proper PPE when handling hydraulic fluid.'),

('33333333-3333-3333-3333-333333333333', 'cccccccc-cccc-cccc-cccc-cccccccccccc', '33333333-3333-3333-3333-333333333333', 'Sprayer Gamma - Air Filter Service', 'Quarterly air filter replacement', 'Filter Replacement', 'engine', 'months', 3, '2024-01-20 10:00:00+00', '2023-12-20 10:00:00+00', 'overdue', 'low', 'David Brown', 0.5, 320, 300,
 ARRAY['Engine Air Filter', 'Cabin Air Filter'],
 ARRAY['Screwdriver Set', 'Compressed Air'],
 'Remove old filters, clean filter housing, install new filters, ensure proper seating',
 'Check filter orientation markings. Do not over-tighten filter housing.'),

('44444444-4444-4444-4444-444444444444', 'dddddddd-dddd-dddd-dddd-dddddddddddd', '44444444-4444-4444-4444-444444444444', 'Seeder Delta - Belt Inspection', 'Bi-weekly belt and chain check', 'Inspection', 'mechanical', 'weeks', 2, '2024-01-25 08:00:00+00', '2024-01-11 08:00:00+00', 'in_progress', 'medium', 'Tom Anderson', 1.0, 1850, 1850,
 ARRAY['Drive Belts', 'Chain Lubricant'],
 ARRAY['Belt Tension Gauge', 'Chain Wear Gauge', 'Grease Gun'],
 'Check belt tension and condition, inspect chains for wear, lubricate as needed',
 'Engine must be off and cool. Keep hands away from moving parts.'),

('55555555-5555-5555-5555-555555555555', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', '55555555-5555-5555-5555-555555555555', 'Utility Echo - Safety Inspection', 'Semi-annual comprehensive safety check', 'Safety Inspection', 'safety', 'months', 6, '2024-03-12 13:00:00+00', '2023-09-12 13:00:00+00', 'scheduled', 'critical', 'Mike Johnson', 4.0, 180, 150,
 ARRAY['Light Bulbs', 'Brake Fluid', 'Safety Equipment'],
 ARRAY['Multimeter', 'Brake Pressure Tester', 'Safety Checklist'],
 'Test all lights and electrical systems, check brake operation, inspect safety equipment',
 'Follow lockout/tagout procedures. Test emergency stops and safety systems thoroughly.');
...
('aaaaaaaa-aaaa-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', 'due_soon', 'medium', 'Due Soon: Tractor Alpha - Oil Change', 'Maintenance for Tractor Alpha is due in 24 hours. Please schedule completion.', 
 ARRAY['in_app', 'email'], ARRAY['Mike Johnson', 'maintenance@farm.com'], 'delivered', '2024-02-04 09:00:00+00', '2024-02-04 09:02:00+00', '2024-02-04 09:05:00+00',
 '{"in_app": {"status": "delivered", "timestamp": "2024-02-04T09:03:00Z"}, "email": {"status": "delivered", "timestamp": "2024-02-04T09:05:00Z"}}'::jsonb,
...
('bbbbbbbb-bbbb-2222-2222-222222222222', '33333333-3333-3333-3333-333333333333', '33333333-3333-3333-3333-333333333333', 'overdue', 'low', 'OVERDUE: Sprayer Gamma - Air Filter Service', 'Maintenance for Sprayer Gamma is 8 days overdue. Please complete as soon as possible.', 
 ARRAY['in_app', 'email', 'sms'], ARRAY['David Brown', 'maintenance@farm.com'], 'delivered', '2024-01-28 08:00:00+00', '2024-01-28 08:01:00+00', '2024-01-28 08:03:00+00',
 '{"in_app": {"status": "delivered", "timestamp": "2024-01-28T08:01:00Z"}, "email": {"status": "delivered", "timestamp": "2024-01-28T08:02:00Z"}, "sms": {"status": "delivered", "timestamp": "2024-01-28T08:03:00Z"}}'::jsonb,
...
('cccccccc-cccc-3333-3333-333333333333', '44444444-4444-4444-4444-444444444444', '44444444-4444-4444-4444-444444444444', 'in_progress', 'medium', 'In Progress: Seeder Delta - Belt Inspection', 'Maintenance for Seeder Delta is currently in progress by Tom Anderson.', 
 ARRAY['in_app'], ARRAY['maintenance@farm.com'], 'delivered', '2024-01-24 08:30:00+00', '2024-01-24 08:31:00+00', '2024-01-24 08:31:00+00',
 '{"in_app": {"status": "delivered", "timestamp": "2024-01-24T08:31:00Z"}}'::jsonb,
...
('aaaaaaaa-aaaa-aaaa-1111-111111111111', '11111111-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', 'Tractor Alpha - Oil Change', 'Scheduled engine oil change for primary tractor', 'maintenance', '2024-02-05 09:00:00+00', '2024-02-05 11:00:00+00', 'Mike Johnson', 'Workshop Bay 1', 'scheduled', '#2563EB', NULL),

('bbbbbbbb-bbbb-bbbb-2222-222222222222', '22222222-2222-2222-2222-222222222222', '22222222-2222-2222-2222-222222222222', 'Harvester Beta - Hydraulic Check', 'Monthly hydraulic system inspection', 'maintenance', '2024-01-28 14:00:00+00', '2024-01-28 15:30:00+00', 'Sarah Williams', 'Field Service', 'scheduled', '#EA580C', NULL),

('cccccccc-cccc-cccc-3333-333333333333', '33333333-3333-3333-3333-333333333333', '33333333-3333-3333-3333-333333333333', 'Sprayer Gamma - Air Filter Service', 'Quarterly air filter replacement (OVERDUE)', 'maintenance', '2024-01-20 10:00:00+00', '2024-01-20 10:30:00+00', 'David Brown', 'Workshop Bay 2', 'confirmed', '#DC2626', NULL),

('dddddddd-dddd-dddd-4444-444444444444', '44444444-4444-4444-4444-444444444444', '44444444-4444-4444-4444-444444444444', 'Seeder Delta - Belt Inspection', 'Bi-weekly belt and chain check (IN PROGRESS)', 'maintenance', '2024-01-25 08:00:00+00', '2024-01-25 09:00:00+00', 'Tom Anderson', 'Workshop Bay 3', 'in_progress', '#2563EB', NULL),

('eeeeeeee-eeee-eeee-5555-555555555555', '55555555-5555-5555-5555-555555555555', '55555555-5555-5555-5555-555555555555', 'Utility Echo - Safety Inspection', 'Semi-annual comprehensive safety check', 'maintenance', '2024-03-12 13:00:00+00', '2024-03-12 17:00:00+00', 'Mike Johnson', 'Safety Inspection Area', 'scheduled', '#DC2626', NULL);
